...
//  public:
//   Unit( const std::shared_ptr<const UnitData> unit_data, const int unit_type );  // @Warning For use by WarMachines
//   ONLY Unit( const std::shared_ptr<const UnitData> unit_data, const std::weak_ptr<Faction> faction, const int
//   unit_type ); sf::Texture& accept( Visitor& v ) const override {
//     return v.visit( *this );
//   }
