...
Unit::Unit( const std::shared_ptr<const UnitData> unit_data, const int unit_type ) : unit_data_( std::move( unit_data ) ), unit_type_( unit_type ) {};

Unit::Unit( const std::shared_ptr<const UnitData> unit_data, const std::weak_ptr<Faction> faction, const int unit_type ) : unit_data_( std::move( unit_data ) ), faction_( faction ), unit_type_( unit_type ) {};
